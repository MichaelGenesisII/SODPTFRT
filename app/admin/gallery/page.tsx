      ...
      <section className="animate-fade-rise mb-4 sm:mb-6">
        ...
        <p className="mt-1.5 max-w-2xl text-sm leading-relaxed text-ink/70">
          {isNationalAdmin(profile)
            ? "Review graduation selfies across the network on the Desk. Open Insight for flag, take down, and delete guidance — and how Records and Payments tie in."
            : "Review graduation selfies for your parish. Open Insight for moderation guidance and links to scorecards and bank proofs."}
        </p>
      </section>
