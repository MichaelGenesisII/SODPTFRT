...
export function buildAssistantSystemPrompt(studentContext: string | null): string {
  return [
    ...
    "- Use plain language; no database, SQL, RLS, admin tools, or infrastructure jargon.",
    ...
    "- You cannot perform actions (pay, reset password, unlock exams). Explain where in the portal the user does it.",
