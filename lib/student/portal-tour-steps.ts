...
export const STUDENT_PORTAL_TOUR_STEPS: StudentPortalTourStep[] = [
  ...
  },
  {
    ...
    body: "Pay in full or by instalment — minimum **£30** each time unless you clear the balance. The **programme fee is £350** (£300 tuition + £50 graduation) as one balance. Card checkout or bank transfer with proof for the desk to approve.",
  ...
  },
  {
    ...
    body: "Progress for the **programme fee** (£350 = £300 tuition + £50 graduation). **Outstanding** at the top is your remaining balance. Your first confirmed instalment unlocks passport upload.",
    href: "/student/payments",
