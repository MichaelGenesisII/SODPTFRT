...
export async function getEmailTemplateOverride(
  ...
  if (data) {
    return {
      ...
      default_subject: data.default_subject as string,
      default_html: data.default_html as string,
      default_text: (data.default_text as string | null) ?? null,
...
export async function listEmailTemplateOverrides(): Promise<EmailTemplateOverride[]> {
  ...
  return EMAIL_TEMPLATE_CATALOG.map((catalog) => {
    ...
    return {
      ...
      default_subject: row.default_subject as string,
      default_html: row.default_html as string,
      default_text: (row.default_text as string | null) ?? null,
