...
export const OVERVIEW_TOUR_STEPS: OverviewTourStep[] = [
  ...
  },
  {
    ...
    quest: 2,
    questLabel: "Your people",
    title: "Feel the *shape* of the cohort",
    body: "These tiles give you the **pulse** before you dig in — how many seats, who's still in review, who's secured, who's paused. *A quick breath before the list.*",
    href: "/admin/students",
  ...
  },
  {
    ...
    body: "Use these **lanes** to narrow the list — In review, On path, Paused. The list stays view-only on purpose; open a row when you're ready to help on the **student file**.",
    href: "/admin/students",
    target: '[data-tour="students-lanes"]',
    expandNavGroup: "cohort",
    cta: "Next · Alumni",
  },
  ...
  // Cohorts ×3
  {
    ...
    quest: 2,
    questLabel: "Your people",
    title: "Programmes have a *home*",
    body: "**Desk** shows who's on an intake. **Manage** is where you create and link programmes. **Insight** walks the year → cohort → batch story if you want the big picture.",
    href: "/admin/cohorts",
    target: '[data-tour="cohorts-tabs"]',
    expandNavGroup: "cohort",
    cta: "Keep going",
  },
  {
    ...
    quest: 2,
    questLabel: "Your people",
    title: "See the intake *at a glance*",
    body: "How many **programmes** you hold, how big the selected **roster** is, which batches are linked, and which intakes are still active — *your map of the year*.",
    href: "/admin/cohorts",
    target: '[data-tour="cohorts-stats"]',
    expandNavGroup: "cohort",
    cta: "Pick a programme",
  },
  {
    id: "COR-03",
    quest: 2,
    questLabel: "Your people",
    title: "Choose a programme, meet the *roster*",
    body: "Tap a programme chip — or **+ New** when you're starting fresh. The **roster** below is your people for that intake; open anyone for their full file.",
    href: "/admin/cohorts",
    target: '[data-tour="cohorts-lanes"]',
    expandNavGroup: "cohort",
    cta: "Next · Payments",
  },
